...
#[allow(dead_code)]
pub const RUSTC: &str = r"C:\\Users\\joanf\\.rustup\\toolchains\\stable-x86_64-pc-windows-gnu\\bin\\rustc.exe";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"C:\\Users\\joanf\\.rustup\\toolchains\\stable-x86_64-pc-windows-gnu\\bin\\rustdoc.exe";
...
#[doc=r#"The output of `C:\Users\joanf\.rustup\toolchains\stable-x86_64-pc-windows-gnu\bin\rustc.exe -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.82.0 (f6e511eec 2024-10-15)";
#[doc=r#"The output of `C:\Users\joanf\.rustup\toolchains\stable-x86_64-pc-windows-gnu\bin\rustdoc.exe -V`; empty string if `C:\Users\joanf\.rustup\toolchains\stable-x86_64-pc-windows-gnu\bin\rustdoc.exe -V` failed to execute"#]
#[allow(dead_code)]
pub const RUSTDOC_VERSION: &str = r"rustdoc 1.82.0 (f6e511eec 2024-10-15)";
